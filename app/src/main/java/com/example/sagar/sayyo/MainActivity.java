package com.example.sagar.sayyo;
    ...
    private void processResult(String command) {
        ...
        if (command.indexOf("what") != -1) {
            if (command.indexOf("your name") != -1) {
                speak("My Name is Sayyo");
                tv.setText("My Name is Sayyo");
        ...
        } else if (command.indexOf("send my coordinates") != -1) {
            ...
            speak("command doesn't work sorry");
        }
    }
